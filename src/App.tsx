...
function DashboardLayout() {
  const db = useDb();
  const [activeTab, setActiveTab] = useState<'dashboard' | 'fleet' | 'violations' | 'deductions' | 'custody_licensing' | 'cross_accounts' | 'license_tracking' | 'reports'>('dashboard');
      ...
      <header className="bg-slate-900/80 backdrop-blur-sm border-b border-slate-800 sticky top-0 z-40 no-print" id="elbanna_main_header">
        <div className="max-w-7xl mx-auto px-4 md:px-6 h-16 flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="hidden sm:flex items-center gap-1.5 text-xs text-slate-300 font-medium font-mono bg-slate-950 px-3 py-1.5 rounded-lg border border-slate-800">
